<div class="row">
    <section class="container">
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo e(Request::segment(3)); ?>">Users</a></li>
        </ol>
    </section>
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="pull-right">
                    ...
                    <a href="<?php echo e(url('employee/add/'.Request::segment(3))); ?>">
...
<script type="text/javascript">
        ...
        $('#patner').DataTable({
            ...
            columns: [
                ...
                {data: 'status', orderable: true},
                {
                    ...
                    return '' +
                        '<a href="<?php echo e(url('employee/detail')); ?>/' + row.id + '">Detail |</a>&nbsp;&nbsp;&nbsp;' +
                        '<a href="<?php echo e(url('employee/edit')); ?>/' + row.id + '">Edit |</a>&nbsp;&nbsp;&nbsp;' +
    ...
    function deleteOrganization(id) {
        ...
        if (r == true) {
            $.ajax({
                url: "<?php echo e(url('employee/delete-employee')); ?>",
                type: "POST",
                data: {
                    id: id
                },
    ...
    $(document).on('change', '[type=checkbox]', function (e) {
        ...
        if (this.checked) {
            ...
            if (r == true) {
                ...
                $.ajax({
                    url: "<?php echo url('employee/delete'); ?>",
                    type: "POST",
                    data: {
                        id: id
                    },
    ...
    $(document).on('change', 'input[name=files][type=file]', function (e) {
        ...
        $.ajax({
            url: "<?php echo url('organizations/upload/'.Request::segment(3)); ?>",
            type: "POST",
            data: data,
            dataType: 'json',
            processData: false,
