...
<script type="text/javascript">
        ...
        $('#patner').DataTable({
            ...
            columns: [
                ...
                {data: 'type_voucher', orderable: true},
                {
                    ...
                    return '' +
                        '<a href="{{ url('organizations/detail') }}/' + row.id + '">Detail |</a>&nbsp;&nbsp;&nbsp;' +
                        '<a href="{{ url('organizations/edit') }}/' + row.id + '">Edit |</a>&nbsp;&nbsp;&nbsp;' +
    ...
    function deleteOrganization(id) {
        ...
        if (r == true) {
            $.ajax({
                url: "{{url('organizations/delete-organization')}}",
                type: "POST",
                data: {
                    id: id
                },
