...
<div class="row">
            ...
            <div class="panel-body">
                <div class="top-stats-panel">
                    <div class="gauge-canvas">
                        <h4 class="widget-h">Voucher Active</h4>
            ...
            <div class="panel-body">
                <div class="top-stats-panel">
                    <div class="daily-visit">
                        <h4 class="widget-h">Voucher Non-Active</h4>
    ...
    <div class="col-md-3">
        <section class="panel">
            <div class="panel-body">
                <div class="top-stats-panel">
                    <h4 class="widget-h">Top Organization</h4>
                    <div class="sm-pie">
                    </div>
                </div>
            </div>
    ...
    <div class="col-md-3">
        <section class="panel">
            <div class="panel-body">
                <div class="top-stats-panel">
                    <h4 class="widget-h">Daily Voucher</h4>
                    <div class="bar-stats">
                        <ul class="progress-stat-bar clearfix">
                            <li data-percent="40%"><span class="progress-stat-percent pink"></span></li>
                            <li data-percent="70%"><span class="progress-stat-percent yellow-b"></span></li>
                        </ul>
                        <ul class="bar-legend">
                            <li><span class="bar-legend-pointer pink"></span> Active</li>
                            <li><span class="bar-legend-pointer yellow-b"></span> Non-Active</li>
                        </ul>
                        <div class="daily-sales-info">
                            <span class="sales-count">1200 </span> <span
                                    class="sales-label"> Voucher</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        {{--<section class="panel">--}}
            {{--<div class="panel-body">--}}
                {{--<div class="monthly-stats pink">--}}
                    {{--<div class="clearfix">--}}
                        ...
                        {{--<div class="btn-group pull-right stat-tab">--}}
                            {{--<a href="#line-chart" class="btn stat-btn active" data-toggle="tab"><i--}}
                                        {{--class="ico-stats"></i></a>--}}
                            {{--<a href="#bar-chart" class="btn stat-btn" data-toggle="tab"><i--}}
                                        {{--class="ico-bars"></i></a>--}}
                        {{--</div>--}}
                    {{--</div>--}}
                    {{--<!-- Tab panes -->--}}
                    {{--<div class="tab-content">--}}
                        {{--<div class="tab-pane active" id="line-chart">--}}
                            {{--<div class="sparkline" data-type="line" data-resize="true" data-height="75"--}}
                                 {{--data-width="90%" data-line-width="1" data-min-spot-color="false"--}}
                                 {{--data-max-spot-color="false" data-line-color="#ffffff"--}}
                                 {{--data-spot-color="#ffffff" data-fill-color=""--}}
                                 {{--data-highlight-line-color="#ffffff" data-highlight-spot-color="#e1b8ff"--}}
                                 {{--data-spot-radius="3"--}}
                                 {{--data-data="[100,200,459,234,600,800,345,987,675,457,765]">--}}
                            {{--</div>--}}
                        {{--</div>--}}
                        {{--<div class="tab-pane" id="bar-chart">--}}
                            {{--<div class="sparkline" data-type="bar" data-resize="true" data-height="75"--}}
                                 {{--data-width="90%" data-bar-color="#d4a7f5" data-bar-width="10"--}}
                ...
                {{--<div class="circle-sat">--}}
                    {{--<ul>--}}
                        {{--<li class="left-stat-label"><span--}}
                                    {{--class="sell-percent">60%</span><span>Direct Sell</span></li>--}}
                        {{--<li><span class="epie-chart" data-percent="45">--}}
                        {{--<span class="percent"></span>--}}
                        {{--</span></li>--}}
                        {{--<li class="right-stat-label"><span--}}
                                    {{--class="sell-percent">40%</span><span>Channel Sell</span></li>--}}
                    {{--</ul>--}}
                {{--</div>--}}
            {{--</div>--}}
        {{--</section>--}}
        ...
        {{--<section class="panel">--}}
            {{--<div class="panel-body">--}}
                {{--<ul class="clearfix prospective-spark-bar">--}}
                    ...
                    {{--</li>--}}
                    {{--<li class="pull-right">--}}
                        {{--<div class="sparkline" data-type="bar" data-resize="true" data-height="40"--}}
                             {{--data-width="90%" data-bar-color="#f6b0ae" data-bar-width="5"--}}
                             {{--data-data="[300,200,500,700,654,987,457,300,876,454,788,300,200,500,700,654,987,457,300,876,454,788]"></div>--}}
                    {{--</li>--}}
                {{--</ul>--}}
            {{--</div>--}}
        ...
        {{--<div class="event-calendar clearfix">--}}
            ...
            {{--<div class="col-lg-5 event-list-block">--}}
                ...
                {{--<ul class="event-list">--}}
                    ...
                    {{--<li>Coffee meeting with Lisa @ 4:30 <a href="#" class="event-close"><i--}}
                                    {{--class="ico-close2"></i></a></li>--}}
                    {{--<li>Skypee conf with patrick @ 5:45 <a href="#" class="event-close"><i--}}
                                    {{--class="ico-close2"></i></a></li>--}}
                    {{--<li>Gym @ 7:00 <a href="#" class="event-close"><i class="ico-close2"></i></a></li>--}}
                    {{--<li>Dinner with daniel @ 9:30 <a href="#" class="event-close"><i class="ico-close2"></i></a>--}}
                    {{--</li>--}}
                ...
                {{--<div class="todo-action-bar">--}}
                    {{--<div class="row">--}}
                        {{--<div class="col-xs-4 btn-todo-select">--}}
                            {{--<button type="submit" class="btn btn-default"><i class="fa fa-check"></i> Select--}}
                                {{--All--}}
                            {{--</button>--}}
                        {{--</div>--}}
                        {{--<div class="col-xs-4 todo-search-wrap">--}}
                            {{--<input type="text" class="form-control search todo-search pull-right"--}}
                                   {{--placeholder=" Search">--}}
                        {{--</div>--}}
